...
from parser.dfwriter import DfWriter
...
if __name__ == "__main__":
    ...
    # # 输出到 CSV 文件
    # dfwriter = DfWriter()
    # dfwriter.output("/Users/yaxuan/Desktop/output/output.csv").format("csv").write(df)

    # dfwriter.output("/Users/yaxuan/Desktop/output/output.arrow").write(df)  # 默认是ARROW格式
